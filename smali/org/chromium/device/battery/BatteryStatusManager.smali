...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lorg/chromium/device/battery/BatteryStatusManager;->mNativePtrLock:Ljava/lang/Object;
...
.method static getInstance(Landroid/content/Context;)Lorg/chromium/device/battery/BatteryStatusManager;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lorg/chromium/device/battery/BatteryStatusManager;-><init>(Landroid/content/Context;)V
...
.method protected gotBatteryStatus(ZDDD)V
    ...
    .prologue
    .line 135
    iget-object v10, p0, Lorg/chromium/device/battery/BatteryStatusManager;->mNativePtrLock:Ljava/lang/Object;

    monitor-enter v10

    .line 136
    :try_start_0
    iget-wide v0, p0, Lorg/chromium/device/battery/BatteryStatusManager;->mNativePtr:J
    ...
    .line 137
    iget-wide v1, p0, Lorg/chromium/device/battery/BatteryStatusManager;->mNativePtr:J
    ...
    invoke-direct/range {v0 .. v9}, Lorg/chromium/device/battery/BatteryStatusManager;->nativeGotBatteryStatus(JZDDD)V
...
.method onReceive(Landroid/content/Intent;)V
    ...
    .line 91
    :cond_0
    invoke-virtual/range {p0 .. p0}, Lorg/chromium/device/battery/BatteryStatusManager;->ignoreBatteryPresentState()Z
    ...
    invoke-virtual/range {v2 .. v9}, Lorg/chromium/device/battery/BatteryStatusManager;->gotBatteryStatus(ZDDD)V
...
.method start(J)Z
    ...
    .prologue
    .line 60
    iget-object v1, p0, Lorg/chromium/device/battery/BatteryStatusManager;->mNativePtrLock:Ljava/lang/Object;
    ...
    iget-object v2, p0, Lorg/chromium/device/battery/BatteryStatusManager;->mReceiver:Landroid/content/BroadcastReceiver;

    iget-object v3, p0, Lorg/chromium/device/battery/BatteryStatusManager;->mFilter:Landroid/content/IntentFilter;
    ...
    .line 63
    iput-wide p1, p0, Lorg/chromium/device/battery/BatteryStatusManager;->mNativePtr:J
...
.method stop()V
    ...
    iput-wide v2, p0, Lorg/chromium/device/battery/BatteryStatusManager;->mNativePtr:J
