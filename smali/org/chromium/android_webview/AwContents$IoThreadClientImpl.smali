.class Lorg/chromium/android_webview/AwContents$IoThreadClientImpl;
...
.method public newLoginRequest(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lorg/chromium/android_webview/AwContents;->access$300(Lorg/chromium/android_webview/AwContents;)Lorg/chromium/android_webview/AwContentsClient;
...
.method public shouldInterceptRequest(Lorg/chromium/android_webview/AwContentsClient$ShouldInterceptRequestParams;)Lorg/chromium/android_webview/AwWebResourceResponse;
    ...
    .prologue
    .line 342
    iget-object v2, p1, Lorg/chromium/android_webview/AwContentsClient$ShouldInterceptRequestParams;->url:Ljava/lang/String;

    .line 345
    .local v2, "url":Ljava/lang/String;
    iget-object v3, p0, Lorg/chromium/android_webview/AwContents$IoThreadClientImpl;->this$0:Lorg/chromium/android_webview/AwContents;

    # getter for: Lorg/chromium/android_webview/AwContents;->mDefaultVideoPosterRequestHandler:Lorg/chromium/android_webview/DefaultVideoPosterRequestHandler;
    invoke-static {v3}, Lorg/chromium/android_webview/AwContents;->access$200(Lorg/chromium/android_webview/AwContents;)Lorg/chromium/android_webview/DefaultVideoPosterRequestHandler;

    move-result-object v3

    invoke-virtual {v3, v2}, Lorg/chromium/android_webview/DefaultVideoPosterRequestHandler;->shouldInterceptRequest(Ljava/lang/String;)Lorg/chromium/android_webview/AwWebResourceResponse;

    move-result-object v0

    .line 346
    .local v0, "awWebResourceResponse":Lorg/chromium/android_webview/AwWebResourceResponse;
    if-eqz v0, :cond_0

    move-object v1, v0

    .line 363
    .end local v0    # "awWebResourceResponse":Lorg/chromium/android_webview/AwWebResourceResponse;
    .local v1, "awWebResourceResponse":Lorg/chromium/android_webview/AwWebResourceResponse;
    :goto_0
    return-object v1

    .line 348
    .end local v1    # "awWebResourceResponse":Lorg/chromium/android_webview/AwWebResourceResponse;
    .restart local v0    # "awWebResourceResponse":Lorg/chromium/android_webview/AwWebResourceResponse;
    :cond_0
    iget-object v3, p0, Lorg/chromium/android_webview/AwContents$IoThreadClientImpl;->this$0:Lorg/chromium/android_webview/AwContents;

    # getter for: Lorg/chromium/android_webview/AwContents;->mContentsClient:Lorg/chromium/android_webview/AwContentsClient;
    invoke-static {v3}, Lorg/chromium/android_webview/AwContents;->access$300(Lorg/chromium/android_webview/AwContents;)Lorg/chromium/android_webview/AwContentsClient;

    move-result-object v3

    invoke-virtual {v3, p1}, Lorg/chromium/android_webview/AwContentsClient;->shouldInterceptRequest(Lorg/chromium/android_webview/AwContentsClient$ShouldInterceptRequestParams;)Lorg/chromium/android_webview/AwWebResourceResponse;
    ...
    invoke-virtual {v3, v2}, Lorg/chromium/android_webview/AwContentsClientCallbackHelper;->postOnLoadResource(Ljava/lang/String;)V

    .line 354
    :cond_1
    iget-boolean v3, p1, Lorg/chromium/android_webview/AwContentsClient$ShouldInterceptRequestParams;->isMainFrame:Z

    if-eqz v3, :cond_2

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lorg/chromium/android_webview/AwWebResourceResponse;->getData()Ljava/io/InputStream;
    ...
    invoke-virtual {v3, v4, v5, v2}, Lorg/chromium/android_webview/AwContentsClientCallbackHelper;->postOnReceivedError(ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 363
    .end local v0    # "awWebResourceResponse":Lorg/chromium/android_webview/AwWebResourceResponse;
    .restart local v1    # "awWebResourceResponse":Lorg/chromium/android_webview/AwWebResourceResponse;
    goto :goto_0
.end method
