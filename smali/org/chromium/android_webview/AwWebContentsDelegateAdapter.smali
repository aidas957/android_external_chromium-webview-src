.class Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;
...
# instance fields
.field private final mAwContents:Lorg/chromium/android_webview/AwContents;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 31
    const-class v0, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;
    ...
    :goto_0
    sput-boolean v0, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;->$assertionsDisabled:Z
...
.method public constructor <init>(Lorg/chromium/android_webview/AwContents;Lorg/chromium/android_webview/AwContentsClient;Lorg/chromium/android_webview/AwContentViewClient;Landroid/content/Context;Landroid/view/View;)V
    .locals 0
    .param p1, "awContents"    # Lorg/chromium/android_webview/AwContents;
    .param p2, "contentsClient"    # Lorg/chromium/android_webview/AwContentsClient;
    .param p3, "contentViewClient"    # Lorg/chromium/android_webview/AwContentViewClient;
    ...
    .line 44
    iput-object p3, p0, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;->mContentViewClient:Lorg/chromium/android_webview/AwContentViewClient;
...
.method static synthetic access$000(Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;)Lorg/chromium/android_webview/AwContents;
    .locals 1
    .param p0, "x0"    # Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;
...
.method static synthetic access$100(Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;
...
.method private tryToMoveFocus(I)Z
    ...
    .prologue
    .line 95
    iget-object v1, p0, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;->mContainerView:Landroid/view/View;
...
.method public addMessageToConsole(ILjava/lang/String;ILjava/lang/String;)Z
    ...
    .line 121
    :goto_0
    iget-object v1, p0, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;->mContentsClient:Lorg/chromium/android_webview/AwContentsClient;
    ...
    invoke-virtual {v1, v2}, Lorg/chromium/android_webview/AwContentsClient;->onConsoleMessage(Landroid/webkit/ConsoleMessage;)Z
...
.method public handleKeyboardEvent(Landroid/view/KeyEvent;)V
    ...
    invoke-virtual {v1, p1}, Lorg/chromium/android_webview/AwContentsClient;->onUnhandledKeyEvent(Landroid/view/KeyEvent;)V
...
.method public navigationStateChanged(I)V
    ...
    invoke-virtual {v1}, Lorg/chromium/android_webview/AwContents;->hasAccessedInitialDocument()Z
    ...
    invoke-virtual {v1}, Lorg/chromium/android_webview/AwContents;->getDidAttemptLoad()Z
    ...
    invoke-virtual {v1}, Lorg/chromium/android_webview/AwContents;->getLastCommittedUrl()Ljava/lang/String;
    ...
    invoke-virtual {v1, v0}, Lorg/chromium/android_webview/AwContentsClient;->onPageStarted(Ljava/lang/String;)V

    .line 228
    iget-object v1, p0, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;->mContentsClient:Lorg/chromium/android_webview/AwContentsClient;

    invoke-virtual {v1, v0}, Lorg/chromium/android_webview/AwContentsClient;->onLoadResource(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2}, Lorg/chromium/android_webview/AwContentsClient;->onProgressChanged(I)V

    .line 230
    iget-object v1, p0, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;->mContentsClient:Lorg/chromium/android_webview/AwContentsClient;

    invoke-virtual {v1, v0}, Lorg/chromium/android_webview/AwContentsClient;->onPageFinished(Ljava/lang/String;)V
...
.method public openNewTab(Ljava/lang/String;Ljava/lang/String;[BIZ)V
    ...
    .prologue
    .line 134
    sget-boolean v0, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;->$assertionsDisabled:Z
...
.method public runFileChooser(IIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .prologue
    .line 181
    new-instance v0, Lorg/chromium/android_webview/AwContentsClient$FileChooserParams;

    invoke-direct {v0}, Lorg/chromium/android_webview/AwContentsClient$FileChooserParams;-><init>()V

    .line 182
    .local v0, "params":Lorg/chromium/android_webview/AwContentsClient$FileChooserParams;
    iput p3, v0, Lorg/chromium/android_webview/AwContentsClient$FileChooserParams;->mode:I

    .line 183
    iput-object p4, v0, Lorg/chromium/android_webview/AwContentsClient$FileChooserParams;->acceptTypes:Ljava/lang/String;

    .line 184
    iput-object p5, v0, Lorg/chromium/android_webview/AwContentsClient$FileChooserParams;->title:Ljava/lang/String;

    .line 185
    iput-object p6, v0, Lorg/chromium/android_webview/AwContentsClient$FileChooserParams;->defaultFilename:Ljava/lang/String;

    .line 186
    iput-boolean p7, v0, Lorg/chromium/android_webview/AwContentsClient$FileChooserParams;->capture:Z

    .line 188
    iget-object v1, p0, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;->mContentsClient:Lorg/chromium/android_webview/AwContentsClient;

    new-instance v2, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter$2;

    invoke-direct {v2, p0, p1, p2, p3}, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter$2;-><init>(Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;III)V

    invoke-virtual {v1, v2, v0}, Lorg/chromium/android_webview/AwContentsClient;->showFileChooser(Landroid/webkit/ValueCallback;Lorg/chromium/android_webview/AwContentsClient$FileChooserParams;)V
...
.method public showRepostFormWarningDialog()V
    ...
    new-instance v1, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter$1;

    invoke-static {}, Lorg/chromium/base/ThreadUtils;->getUiThreadLooper()Landroid/os/Looper;

    move-result-object v5

    invoke-direct {v1, p0, v5}, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter$1;-><init>(Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;Landroid/os/Looper;)V
    ...
    iget-object v5, p0, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;->mContentsClient:Lorg/chromium/android_webview/AwContentsClient;

    invoke-virtual {v5, v0, v4}, Lorg/chromium/android_webview/AwContentsClient;->onFormResubmission(Landroid/os/Message;Landroid/os/Message;)V
...
.method public takeFocus(Z)Z
    ...
    .line 86
    iget-object v2, p0, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;->mContainerView:Landroid/view/View;
...
.method public toggleFullscreenModeForTab(Z)V
    ...
    .line 237
    iget-object v1, p0, Lorg/chromium/android_webview/AwWebContentsDelegateAdapter;->mContentViewClient:Lorg/chromium/android_webview/AwContentViewClient;

    invoke-virtual {v1}, Lorg/chromium/android_webview/AwContentViewClient;->enterFullscreen()V
    ...
    invoke-virtual {v1}, Lorg/chromium/android_webview/AwContentViewClient;->exitFullscreen()V
