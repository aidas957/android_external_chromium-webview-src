...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lorg/chromium/android_webview/AndroidProtocolHandler;->$assertionsDisabled:Z
...
.method public static getMimeType(Landroid/content/Context;Ljava/io/InputStream;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 159
    invoke-static {p2}, Lorg/chromium/android_webview/AndroidProtocolHandler;->verifyUrl(Ljava/lang/String;)Landroid/net/Uri;
...
.method public static open(Landroid/content/Context;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    .line 42
    invoke-static {p1}, Lorg/chromium/android_webview/AndroidProtocolHandler;->verifyUrl(Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 50
    invoke-static {p0, v2}, Lorg/chromium/android_webview/AndroidProtocolHandler;->openAsset(Landroid/content/Context;Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    .line 52
    invoke-static {p0, v2}, Lorg/chromium/android_webview/AndroidProtocolHandler;->openResource(Landroid/content/Context;Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    .line 55
    invoke-static {p0, v2}, Lorg/chromium/android_webview/AndroidProtocolHandler;->openContent(Landroid/content/Context;Landroid/net/Uri;)Ljava/io/InputStream;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static openAsset(Landroid/content/Context;Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    .prologue
    .line 127
    sget-boolean v3, Lorg/chromium/android_webview/AndroidProtocolHandler;->$assertionsDisabled:Z
...
.method private static openContent(Landroid/content/Context;Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    .prologue
    .line 141
    sget-boolean v1, Lorg/chromium/android_webview/AndroidProtocolHandler;->$assertionsDisabled:Z
...
.method private static openResource(Landroid/content/Context;Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    .line 79
    sget-boolean v8, Lorg/chromium/android_webview/AndroidProtocolHandler;->$assertionsDisabled:Z
    ...
    .line 106
    :cond_5
    invoke-static {p0, v2, v0}, Lorg/chromium/android_webview/AndroidProtocolHandler;->getFieldId(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)I

    move-result v4

    .line 107
    .local v4, "fieldId":I
    invoke-static {p0, v4}, Lorg/chromium/android_webview/AndroidProtocolHandler;->getValueType(Landroid/content/Context;I)I
