.class Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;
...
# instance fields
.field private mFullScreenView:Lorg/chromium/android_webview/FullScreenView;

.field private final mInitialAwViewMethods:Lorg/chromium/android_webview/AwViewMethods;

.field private final mInitialContainerView:Landroid/view/ViewGroup;

.field private final mInitialInternalAccessAdapter:Lorg/chromium/android_webview/AwContents$InternalAccessDelegate;

.field private mWasInitialContainerViewFocused:Z


# direct methods
.method private constructor <init>(Landroid/view/ViewGroup;Lorg/chromium/android_webview/AwContents$InternalAccessDelegate;Lorg/chromium/android_webview/AwViewMethods;)V
    .locals 0
    .param p1, "initialContainerView"    # Landroid/view/ViewGroup;
    .param p2, "initialInternalAccessAdapter"    # Lorg/chromium/android_webview/AwContents$InternalAccessDelegate;
    .param p3, "initialAwViewMethods"    # Lorg/chromium/android_webview/AwViewMethods;
...
.method synthetic constructor <init>(Landroid/view/ViewGroup;Lorg/chromium/android_webview/AwContents$InternalAccessDelegate;Lorg/chromium/android_webview/AwViewMethods;Lorg/chromium/android_webview/AwContents$1;)V
    .locals 0
    .param p1, "x0"    # Landroid/view/ViewGroup;
    .param p2, "x1"    # Lorg/chromium/android_webview/AwContents$InternalAccessDelegate;
    .param p3, "x2"    # Lorg/chromium/android_webview/AwViewMethods;
    .param p4, "x3"    # Lorg/chromium/android_webview/AwContents$1;
...
.method static synthetic access$2600(Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;)Z
    .locals 1
    .param p0, "x0"    # Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;
...
.method static synthetic access$2700(Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;Lorg/chromium/android_webview/FullScreenView;Z)V
    .locals 0
    .param p0, "x0"    # Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;
    .param p1, "x1"    # Lorg/chromium/android_webview/FullScreenView;
    .param p2, "x2"    # Z

    .prologue
    .line 275
    invoke-direct {p0, p1, p2}, Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;->enterFullScreen(Lorg/chromium/android_webview/FullScreenView;Z)V

    return-void
.end method

.method static synthetic access$2800(Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;)Lorg/chromium/android_webview/AwViewMethods;
    .locals 1
    .param p0, "x0"    # Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;
...
.method static synthetic access$2900(Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;)Lorg/chromium/android_webview/FullScreenView;
    .locals 1
    .param p0, "x0"    # Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;
...
.method static synthetic access$3000(Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;)Landroid/view/ViewGroup;
    .locals 1
    .param p0, "x0"    # Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;
...
.method static synthetic access$3100(Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;)Lorg/chromium/android_webview/AwContents$InternalAccessDelegate;
    .locals 1
    .param p0, "x0"    # Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;
...
.method static synthetic access$3200(Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;)Z
    .locals 1
    .param p0, "x0"    # Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;
...
.method static synthetic access$3300(Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;)V
    .locals 0
    .param p0, "x0"    # Lorg/chromium/android_webview/AwContents$FullScreenTransitionsState;
...
.method private enterFullScreen(Lorg/chromium/android_webview/FullScreenView;Z)V
    .locals 0
    .param p1, "fullScreenView"    # Lorg/chromium/android_webview/FullScreenView;
