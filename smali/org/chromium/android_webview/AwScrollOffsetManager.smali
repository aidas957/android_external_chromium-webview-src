...
.field private final mDelegate:Lorg/chromium/android_webview/AwScrollOffsetManager$Delegate;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 18
    const-class v0, Lorg/chromium/android_webview/AwScrollOffsetManager;
    ...
    :goto_0
    sput-boolean v0, Lorg/chromium/android_webview/AwScrollOffsetManager;->$assertionsDisabled:Z
...
.method public constructor <init>(Lorg/chromium/android_webview/AwScrollOffsetManager$Delegate;Landroid/widget/OverScroller;)V
    .locals 0
    ...
    .line 81
    iput-object p2, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mScroller:Landroid/widget/OverScroller;
...
.method private animateScrollTo(II)Z
    ...
    .line 328
    :cond_0
    iget-object v0, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mScroller:Landroid/widget/OverScroller;

    invoke-static {v3, v4}, Lorg/chromium/android_webview/AwScrollOffsetManager;->computeDurationInMilliSec(II)I
    ...
    invoke-interface {v0}, Lorg/chromium/android_webview/AwScrollOffsetManager$Delegate;->invalidate()V
...
.method private scrollBy(II)V
    ...
    iget-boolean v7, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mProcessingTouchEvent:Z

    move v1, p1

    move v2, p2

    invoke-interface/range {v0 .. v7}, Lorg/chromium/android_webview/AwScrollOffsetManager$Delegate;->overScrollContainerViewBy(IIIIIIZ)V
...
.method private scrollNativeTo(II)V
    ...
    iput-boolean v0, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mApplyDeferredNativeScroll:Z
...
.method public computeScrollAndAbsorbGlow(Lorg/chromium/android_webview/OverScrollGlow;)V
    .locals 8
    .param p1, "overScrollGlow"    # Lorg/chromium/android_webview/OverScrollGlow;
    ...
    iget-boolean v0, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mWasFlinging:Z
    ...
    iput-boolean v0, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mWasFlinging:Z
    ...
    invoke-virtual/range {v0 .. v7}, Lorg/chromium/android_webview/OverScrollGlow;->absorbGlow(IIIIIIF)V
    ...
    invoke-direct {p0, v0, v7}, Lorg/chromium/android_webview/AwScrollOffsetManager;->scrollBy(II)V
...
.method public isFlingActive()Z
    ...
    .prologue
    .line 167
    iget-object v1, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mScroller:Landroid/widget/OverScroller;
    ...
    .line 168
    .local v0, "flinging":Z
    iget-boolean v1, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mWasFlinging:Z

    or-int/2addr v1, v0

    iput-boolean v1, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mWasFlinging:Z
...
.method public onContainerViewOverScrolled(IIZZ)V
    ...
    invoke-interface {v0, p1, p2}, Lorg/chromium/android_webview/AwScrollOffsetManager$Delegate;->scrollContainerViewTo(II)V
    ...
    invoke-direct {p0, v0, v1}, Lorg/chromium/android_webview/AwScrollOffsetManager;->scrollNativeTo(II)V
...
.method public onUnhandledFlingStartEvent(II)V
    ...
    invoke-virtual {p0, v0, v1}, Lorg/chromium/android_webview/AwScrollOffsetManager;->flingScroll(II)V
...
.method public pageDown(Z)Z
    ...
    .prologue
    .line 358
    iget-object v3, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mDelegate:Lorg/chromium/android_webview/AwScrollOffsetManager$Delegate;

    invoke-interface {v3}, Lorg/chromium/android_webview/AwScrollOffsetManager$Delegate;->getContainerViewScrollX()I
    ...
    invoke-interface {v3}, Lorg/chromium/android_webview/AwScrollOffsetManager$Delegate;->getContainerViewScrollY()I
    ...
    invoke-direct {p0, v1, v3}, Lorg/chromium/android_webview/AwScrollOffsetManager;->animateScrollTo(II)Z
    ...
    .line 364
    :cond_0
    iget v3, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mContainerViewHeight:I
...
.method public requestChildRectangleOnScreen(IILandroid/graphics/Rect;Z)Z
    ...
    .prologue
    .line 385
    iget-object v9, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mDelegate:Lorg/chromium/android_webview/AwScrollOffsetManager$Delegate;

    invoke-interface {v9}, Lorg/chromium/android_webview/AwScrollOffsetManager$Delegate;->getContainerViewScrollX()I
    ...
    invoke-interface {v9}, Lorg/chromium/android_webview/AwScrollOffsetManager$Delegate;->getContainerViewScrollY()I
    ...
    iget v9, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mContainerViewHeight:I
    ...
    iget v9, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mContainerViewWidth:I
    ...
    iget v10, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mContainerViewWidth:I
    ...
    .line 428
    invoke-direct {p0, v6, v8}, Lorg/chromium/android_webview/AwScrollOffsetManager;->scrollBy(II)V
    ...
    invoke-direct {p0, v9, v10}, Lorg/chromium/android_webview/AwScrollOffsetManager;->animateScrollTo(II)Z
...
.method public setProcessingTouchEvent(Z)V
    ...
    .prologue
    .line 139
    sget-boolean v0, Lorg/chromium/android_webview/AwScrollOffsetManager;->$assertionsDisabled:Z
    ...
    iget-boolean v0, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mApplyDeferredNativeScroll:Z
    ...
    .line 144
    iget v0, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mDeferredNativeScrollX:I

    iget v1, p0, Lorg/chromium/android_webview/AwScrollOffsetManager;->mDeferredNativeScrollY:I
