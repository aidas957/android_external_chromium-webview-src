.class public Lcom/android/org/chromium/base/ThreadUtils;
...
.method static constructor <clinit>()V
    ...
    .line 18
    const-class v0, Lcom/android/org/chromium/base/ThreadUtils;
    ...
    :goto_0
    sput-boolean v0, Lcom/android/org/chromium/base/ThreadUtils;->$assertionsDisabled:Z
    ...
    sput-object v0, Lcom/android/org/chromium/base/ThreadUtils;->sLock:Ljava/lang/Object;

    .line 22
    sput-boolean v1, Lcom/android/org/chromium/base/ThreadUtils;->sWillOverride:Z

    .line 24
    const/4 v0, 0x0

    sput-object v0, Lcom/android/org/chromium/base/ThreadUtils;->sUiThreadHandler:Landroid/os/Handler;
...
.method public static assertOnUiThread()V
    ...
    .prologue
    .line 187
    sget-boolean v0, Lcom/android/org/chromium/base/ThreadUtils;->$assertionsDisabled:Z
...
.method private static getUiThreadHandler()Landroid/os/Handler;
    ...
    .prologue
    .line 45
    sget-object v1, Lcom/android/org/chromium/base/ThreadUtils;->sLock:Ljava/lang/Object;

    monitor-enter v1

    .line 46
    :try_start_0
    sget-object v0, Lcom/android/org/chromium/base/ThreadUtils;->sUiThreadHandler:Landroid/os/Handler;

    if-nez v0, :cond_1

    .line 47
    sget-boolean v0, Lcom/android/org/chromium/base/ThreadUtils;->sWillOverride:Z
...
.method public static getUiThreadLooper()Landroid/os/Looper;
    ...
    .prologue
    .line 198
    invoke-static {}, Lcom/android/org/chromium/base/ThreadUtils;->getUiThreadHandler()Landroid/os/Handler;
...
.method public static runOnUiThread(Ljava/util/concurrent/FutureTask;)Ljava/util/concurrent/FutureTask;
    ...
    .line 120
    :cond_0
    invoke-static {p0}, Lcom/android/org/chromium/base/ThreadUtils;->postOnUiThread(Ljava/util/concurrent/FutureTask;)Ljava/util/concurrent/FutureTask;
...
.method public static runOnUiThreadBlocking(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    invoke-static {v1}, Lcom/android/org/chromium/base/ThreadUtils;->runOnUiThread(Ljava/util/concurrent/FutureTask;)Ljava/util/concurrent/FutureTask;
...
.method public static runOnUiThreadBlocking(Ljava/lang/Runnable;)V
    ...
    invoke-static {v1}, Lcom/android/org/chromium/base/ThreadUtils;->postOnUiThread(Ljava/util/concurrent/FutureTask;)Ljava/util/concurrent/FutureTask;
...
.method public static runOnUiThreadBlockingNoException(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    .local p0, "c":Ljava/util/concurrent/Callable;, "Ljava/util/concurrent/Callable<TT;>;"
    :try_start_0
    invoke-static {p0}, Lcom/android/org/chromium/base/ThreadUtils;->runOnUiThreadBlocking(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    :try_end_0
...
.method public static setUiThread(Landroid/os/Looper;)V
    ...
    sget-object v3, Lcom/android/org/chromium/base/ThreadUtils;->sUiThreadHandler:Landroid/os/Handler;
...
.method public static setWillOverrideUiThread()V
    ...
    :try_start_0
    sput-boolean v0, Lcom/android/org/chromium/base/ThreadUtils;->sWillOverride:Z
