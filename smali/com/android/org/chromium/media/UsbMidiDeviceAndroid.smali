.class Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;
...
.method constructor <init>(Landroid/hardware/usb/UsbManager;Landroid/hardware/usb/UsbDevice;)V
    ...
    iput-object v4, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mConnection:Landroid/hardware/usb/UsbDeviceConnection;
    ...
    iput-object v4, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mEndpointMap:Landroid/util/SparseArray;
    ...
    iput-object v4, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mRequestMap:Ljava/util/Map;
    ...
    iput-object v4, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mHandler:Landroid/os/Handler;

    .line 82
    iput-boolean v5, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mIsClosed:Z

    .line 83
    iput-boolean v5, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mHasInputThread:Z

    .line 84
    const-wide/16 v4, 0x0

    iput-wide v4, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mNativePointer:J
    ...
    .line 92
    :cond_1
    iget-object v4, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mConnection:Landroid/hardware/usb/UsbDeviceConnection;
    ...
    .line 96
    iget-object v4, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mEndpointMap:Landroid/util/SparseArray;
    ...
    .end local v3    # "j":I
    :cond_3
    invoke-direct {p0, p2}, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->startListen(Landroid/hardware/usb/UsbDevice;)V

    .line 106
    return-void
.end method

.method static synthetic access$000(Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;)Landroid/hardware/usb/UsbDeviceConnection;
    .locals 1
    .param p0, "x0"    # Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;

    .prologue
    .line 31
    iget-object v0, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mConnection:Landroid/hardware/usb/UsbDeviceConnection;
...
.method static synthetic access$100(Ljava/nio/ByteBuffer;)I
    ...
    .prologue
    .line 31
    invoke-static {p0}, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->getInputDataLength(Ljava/nio/ByteBuffer;)I
...
.method static synthetic access$200(Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;I[B)V
    .locals 0
    .param p0, "x0"    # Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;
    .param p1, "x1"    # I
    .param p2, "x2"    # [B
    ...
    .prologue
    .line 31
    invoke-direct {p0, p1, p2}, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->postOnDataEvent(I[B)V

    return-void
.end method

.method static synthetic access$300(Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;

    .prologue
    .line 31
    iget-boolean v0, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mIsClosed:Z

    return v0
.end method

.method static synthetic access$400(Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;)J
    .locals 2
    .param p0, "x0"    # Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;

    .prologue
    .line 31
    iget-wide v0, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mNativePointer:J
...
.method static synthetic access$500(JI[B)V
    ...
    .prologue
    .line 31
    invoke-static {p0, p1, p2, p3}, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->nativeOnData(JI[B)V
...
.method private postOnDataEvent(I[B)V
    ...
    .prologue
    .line 169
    iget-object v0, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mHandler:Landroid/os/Handler;

    new-instance v1, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid$2;

    invoke-direct {v1, p0, p1, p2}, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid$2;-><init>(Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;I[B)V
...
.method private shouldUseBulkTransfer()Z
    ...
    .prologue
    .line 231
    iget-boolean v0, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mHasInputThread:Z
...
.method private startListen(Landroid/hardware/usb/UsbDevice;)V
    ...
    iget-object v7, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mConnection:Landroid/hardware/usb/UsbDeviceConnection;
    ...
    .line 135
    :cond_4
    iput-boolean v9, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mHasInputThread:Z

    .line 137
    new-instance v7, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid$1;

    invoke-direct {v7, p0, v1}, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid$1;-><init>(Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;Ljava/util/Map;)V

    invoke-virtual {v7}, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid$1;->start()V
...
.method close()V
    ...
    .prologue
    .line 251
    iget-object v2, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mEndpointMap:Landroid/util/SparseArray;

    invoke-virtual {v2}, Landroid/util/SparseArray;->clear()V

    .line 252
    iget-object v2, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mRequestMap:Ljava/util/Map;
    ...
    .line 256
    iget-object v2, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mConnection:Landroid/hardware/usb/UsbDeviceConnection;
    ...
    iput-wide v2, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mNativePointer:J

    .line 258
    const/4 v2, 0x1

    iput-boolean v2, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mIsClosed:Z
...
.method registerSelf(J)V
    ...
    .prologue
    .line 185
    iput-wide p1, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mNativePointer:J
...
.method send(I[B)V
    ...
    .prologue
    .line 196
    iget-boolean v3, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mIsClosed:Z
    ...
    .line 199
    :cond_1
    iget-object v3, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mEndpointMap:Landroid/util/SparseArray;
    ...
    .line 203
    invoke-direct {p0}, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->shouldUseBulkTransfer()Z
    ...
    .line 214
    .local v2, "timeout":I
    iget-object v3, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mConnection:Landroid/hardware/usb/UsbDeviceConnection;
    ...
    :cond_2
    iget-object v3, p0, Lcom/android/org/chromium/media/UsbMidiDeviceAndroid;->mRequestMap:Ljava/util/Map;
