.class public Lcom/android/org/chromium/media/MediaPlayerBridge;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/org/chromium/media/MediaPlayerBridge$AllowedOperations;,
        Lcom/android/org/chromium/media/MediaPlayerBridge$LoadDataUriTask;
    }
.end annotation


# instance fields
.field private mLoadDataUriTask:Lcom/android/org/chromium/media/MediaPlayerBridge$LoadDataUriTask;
...
.method protected constructor <init>(J)V
    ...
    .line 52
    iput-wide p1, p0, Lcom/android/org/chromium/media/MediaPlayerBridge;->mNativeMediaPlayerBridge:J

    .line 53
    return-void
.end method

.method static synthetic access$000(Lcom/android/org/chromium/media/MediaPlayerBridge;)J
    .locals 2
    .param p0, "x0"    # Lcom/android/org/chromium/media/MediaPlayerBridge;

    .prologue
    .line 36
    iget-wide v0, p0, Lcom/android/org/chromium/media/MediaPlayerBridge;->mNativeMediaPlayerBridge:J

    return-wide v0
.end method

.method static synthetic access$100(Lcom/android/org/chromium/media/MediaPlayerBridge;JZ)V
    .locals 1
    .param p0, "x0"    # Lcom/android/org/chromium/media/MediaPlayerBridge;
    .param p1, "x1"    # J
    .param p3, "x2"    # Z
    ...
    .prologue
    .line 36
    invoke-direct {p0, p1, p2, p3}, Lcom/android/org/chromium/media/MediaPlayerBridge;->nativeOnDidSetDataUriDataSource(JZ)V

    return-void
.end method

.method private static create(J)Lcom/android/org/chromium/media/MediaPlayerBridge;
    .locals 2
    .param p0, "nativeMediaPlayerBridge"    # J

    .prologue
    .line 48
    new-instance v0, Lcom/android/org/chromium/media/MediaPlayerBridge;

    invoke-direct {v0, p0, p1}, Lcom/android/org/chromium/media/MediaPlayerBridge;-><init>(J)V
...
.method protected destroy()V
    ...
    .prologue
    .line 60
    iget-object v0, p0, Lcom/android/org/chromium/media/MediaPlayerBridge;->mLoadDataUriTask:Lcom/android/org/chromium/media/MediaPlayerBridge$LoadDataUriTask;
    ...
    invoke-virtual {v0, v1}, Lcom/android/org/chromium/media/MediaPlayerBridge$LoadDataUriTask;->cancel(Z)Z

    .line 62
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/org/chromium/media/MediaPlayerBridge;->mLoadDataUriTask:Lcom/android/org/chromium/media/MediaPlayerBridge$LoadDataUriTask;

    .line 64
    :cond_0
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/android/org/chromium/media/MediaPlayerBridge;->mNativeMediaPlayerBridge:J

    .line 65
    return-void
.end method

.method protected getAllowedOperations()Lcom/android/org/chromium/media/MediaPlayerBridge$AllowedOperations;
    .locals 18

    .prologue
    .line 320
    invoke-virtual/range {p0 .. p0}, Lcom/android/org/chromium/media/MediaPlayerBridge;->getLocalPlayer()Landroid/media/MediaPlayer;
    ...
    :cond_3
    :goto_2
    new-instance v13, Lcom/android/org/chromium/media/MediaPlayerBridge$AllowedOperations;

    invoke-direct {v13, v0, v2, v1}, Lcom/android/org/chromium/media/MediaPlayerBridge$AllowedOperations;-><init>(ZZZ)V
...
.method protected getCurrentPosition()I
    ...
    .prologue
    .line 107
    invoke-virtual {p0}, Lcom/android/org/chromium/media/MediaPlayerBridge;->getLocalPlayer()Landroid/media/MediaPlayer;
...
.method protected getLocalPlayer()Landroid/media/MediaPlayer;
    ...
    .prologue
    .line 68
    iget-object v0, p0, Lcom/android/org/chromium/media/MediaPlayerBridge;->mPlayer:Landroid/media/MediaPlayer;
    ...
    iput-object v0, p0, Lcom/android/org/chromium/media/MediaPlayerBridge;->mPlayer:Landroid/media/MediaPlayer;
...
.method protected setDataUriDataSource(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 177
    iget-object v7, p0, Lcom/android/org/chromium/media/MediaPlayerBridge;->mLoadDataUriTask:Lcom/android/org/chromium/media/MediaPlayerBridge$LoadDataUriTask;
    ...
    invoke-virtual {v7, v6}, Lcom/android/org/chromium/media/MediaPlayerBridge$LoadDataUriTask;->cancel(Z)Z

    .line 179
    const/4 v7, 0x0

    iput-object v7, p0, Lcom/android/org/chromium/media/MediaPlayerBridge;->mLoadDataUriTask:Lcom/android/org/chromium/media/MediaPlayerBridge$LoadDataUriTask;
    ...
    .line 193
    new-instance v7, Lcom/android/org/chromium/media/MediaPlayerBridge$LoadDataUriTask;

    invoke-direct {v7, p0, p1, v0}, Lcom/android/org/chromium/media/MediaPlayerBridge$LoadDataUriTask;-><init>(Lcom/android/org/chromium/media/MediaPlayerBridge;Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v5}, Lcom/android/org/chromium/media/MediaPlayerBridge$LoadDataUriTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
