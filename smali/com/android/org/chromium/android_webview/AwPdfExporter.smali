.class public Lcom/android/org/chromium/android_webview/AwPdfExporter;
...
.method constructor <init>(Landroid/view/ViewGroup;)V
    ...
    .line 38
    invoke-virtual {p0, p1}, Lcom/android/org/chromium/android_webview/AwPdfExporter;->setContainerView(Landroid/view/ViewGroup;)V
...
.method private didExportPdf(Z)V
    ...
    .line 101
    iget-object v0, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mResultCallback:Landroid/webkit/ValueCallback;
    ...
    .line 102
    iput-object v2, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mResultCallback:Landroid/webkit/ValueCallback;

    .line 103
    iput-object v2, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mAttributes:Landroid/print/PrintAttributes;

    .line 105
    iput-object v2, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mFd:Landroid/os/ParcelFileDescriptor;
...
.method private getBottomMargin()I
    ...
    .prologue
    .line 140
    iget-object v0, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mAttributes:Landroid/print/PrintAttributes;
...
.method private getDpi()I
    ...
    invoke-static {v0}, Lcom/android/org/chromium/android_webview/AwPdfExporter;->getPrintDpi(Landroid/print/PrintAttributes;)I
...
.method private setNativeAwPdfExporter(J)V
    ...
    .prologue
    .line 78
    iput-wide p1, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mNativeAwPdfExporter:J
    ...
    iput-object v0, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mResultCallback:Landroid/webkit/ValueCallback;
...
.method public exportToPdf(Landroid/os/ParcelFileDescriptor;Landroid/print/PrintAttributes;Landroid/webkit/ValueCallback;Landroid/os/CancellationSignal;)V
    ...
    .line 66
    :cond_5
    iget-wide v0, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mNativeAwPdfExporter:J
    ...
    .line 70
    :cond_6
    iput-object p3, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mResultCallback:Landroid/webkit/ValueCallback;

    .line 71
    iput-object p2, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mAttributes:Landroid/print/PrintAttributes;

    .line 72
    iput-object p1, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mFd:Landroid/os/ParcelFileDescriptor;

    .line 73
    iget-wide v0, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mNativeAwPdfExporter:J

    iget-object v2, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mFd:Landroid/os/ParcelFileDescriptor;

    invoke-virtual {v2}, Landroid/os/ParcelFileDescriptor;->getFd()I

    move-result v2

    invoke-direct {p0, v0, v1, v2, p4}, Lcom/android/org/chromium/android_webview/AwPdfExporter;->nativeExportToPdf(JILandroid/os/CancellationSignal;)V
...
.method public setContainerView(Landroid/view/ViewGroup;)V
    ...
    .prologue
    .line 42
    iput-object p1, p0, Lcom/android/org/chromium/android_webview/AwPdfExporter;->mContainerView:Landroid/view/ViewGroup;
